...
drop policy if exists "personal fasting sessions" on public.fasting_sessions;
...
create policy "personal fasting sessions" on public.fasting_sessions for all to anon using (true) with check (true);