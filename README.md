...
Features include day-by-day history, searchable food presets with scalable serving sizes, exercise calorie estimates, personal calorie/macro goals, reusable daily habits with dated checkoffs, and continuous fasting sessions that stay active across midnight with editable start, goal, and end times.
